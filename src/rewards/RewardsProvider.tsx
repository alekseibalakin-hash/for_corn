...
import { depthMirror, blocksDepthMirror, flowDepthMirror } from '../games/match3/depthMirror';
    ...
    (async () => {
      ...
      try {
        ...
        if (forceReset || ver !== STORAGE_VERSION) {
          ...
          flowDepthMirror.clear(); // §2.2 flow-phase2: и зеркало глубины Flow (fl_depth_)
